...
RAG_RERANKER_TYPE = os.getenv("RAG_RERANKER_TYPE", "hybrid")
...
RAG_ENABLE_EVIDENCE_GUARD = get_bool_env("RAG_ENABLE_EVIDENCE_GUARD", True)
RAG_MIN_LEXICAL_EVIDENCE_SCORE = get_float_env(
