...
def _build_query_prompt(query: str, retrieved_data: str) -> str:
    return (
        ...
        "Your support scope includes carbon footprint, sustainability, ESG, export "
        "regulations, WeaveCarbon product guidance, sustainability certifications, "
        "logistics, and green supply chains.\n"
        "Politely refuse unrelated topics, competitor platform details, or specific "
        "legal or financial advice.\n"
        "Answer in Vietnamese, use bullet points for multi-step guidance, cite "
        "specific details from the reference data when available, and end with one "
